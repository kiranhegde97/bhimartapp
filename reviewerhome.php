...
<title>reviewer| <?php echo $_SESSION['user']['role']; ?> edit </title>
...
SELECT DISTINCT(User_Name), User_id, COUNT(u.User_id) as c  FROM product_master p,user_master u WHERE p.Editor=u.User_id GROUP by p.Editor")
